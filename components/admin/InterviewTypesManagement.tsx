...
import { useInterviewTypes, useCreateInterviewType, useUpdateInterviewType, useDeleteInterviewType } from '@/hooks/api/useInterviewTypes';
import { InterviewType, InterviewTypeCreate, InterviewTypeUpdate } from '@/types/api';

export function InterviewTypesManagement() {
      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          <DialogTrigger asChild>
            <Button><Plus className="w-4 h-4 mr-2" />Add Interview Type</Button>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
            ...
            <TableRow key={interviewType.id}>
              ...
              <TableCell>
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => setEditingInterviewType(interviewType)}>
                    <Edit className="w-4 h-4" />
                  </Button>
                  <Button variant="destructive" size="sm" onClick={() => handleDelete(interviewType.id)}>
...
function InterviewTypeForm({ interviewType, onSubmit }: { interviewType?: InterviewType; onSubmit: (data: any) => void }) {
